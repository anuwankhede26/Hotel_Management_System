...
<section class="header">
   ...
   <nav class="navbar">
     ...
     <nav class="navbar">
            ...
            <a href="rbooking1.php">Rooms Booking </a>
    ...
    <!-- header section ends -->
    <h1 style="color:purple;"> Rooms Booking Form</h1>
    <div class="bg-agile">
                    ...
                    <div class="agileits_reservation_grid">
                       ...
                       <?php 
                        ...
                        <?php   }
                                   ...
                                   <input  id ='amt'   class='input-field' type="text" value='6500' readonly>
                        <?php   } else { echo 'no'; } ?>
                            </div>
                        </div>
                       ...
                       <div class="phone_email">
                        ...
                        <label class='input-label' for="checkin" >Check-in</label>
                                        <input class='input-field' type="date" id="checkin" name="Checkin" onchange="CompareDate(event);" required>
									</div> 
								</div>
                        <div class="phone_email">
                            <div class="form-text">
